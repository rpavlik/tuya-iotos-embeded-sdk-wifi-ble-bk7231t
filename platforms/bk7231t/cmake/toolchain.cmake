...
set(BK7231_LINKER_SCRIPT "${CMAKE_CURRENT_LIST_DIR}/../bk7231t_os/beken378/build/bk7231.ld" CACHE INTERNAL "" FORCE)
set(BK7231_OTA_LINKER_SCRIPT "${CMAKE_CURRENT_LIST_DIR}/../bk7231t_os/beken378/build/bk7231_ota.ld" CACHE INTERNAL "" FORCE)
set(BK7231_CONFIG_JSON_IN "${CMAKE_CURRENT_LIST_DIR}/config.json.in" CACHE INTERNAL "" FORCE)
set(BK7231_BOOTLOADER "${tools_dir}/bootloader.bin")
set(BK7231_ENC_BOOTLOADER "${tools_dir}/bootloader_enc.bin")

set(BEKEN_ENCRYPT "${tools_bin}/encrypt${toolchain_suffix}")
set(BEKEN_OTAFIX "${tools_bin}/otafix${toolchain_suffix}")
set(BEKEN_PACKAGER "${tools_bin}/beken_packager${toolchain_suffix}")
...
set(CMAKE_NM ${toolchain_bin}/${triple}-nm${toolchain_suffix})
...
set(CMAKE_C_FLAGS_INIT   " -mthumb -mcpu=arm968e-s -march=armv5te -mthumb-interwork -mlittle-endian -ffunction-sections -fsigned-char -fdata-sections -std=c99")
set(CMAKE_CXX_FLAGS_INIT " -mthumb -mcpu=arm968e-s -march=armv5te -mthumb-interwork -mlittle-endian -ffunction-sections -fsigned-char -fdata-sections")
